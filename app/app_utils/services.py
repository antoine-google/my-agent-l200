...
def get_memory_service():
    """Process-wide persistent vector memory service."""
    if agent_engine_id := os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID"):
        try:
    ...
    from app.app_utils.vector_memory_service import PersistentVectorMemoryService

    return PersistentVectorMemoryService()
